...
class AidSelectFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.cardViewAnimal.setOnClickListener {
            val action = AidSelectFragmentDirections.actionAidSelectFragmentToAidMapFragment("animal")
            Navigation.findNavController(it).navigate(action)
        }

        binding.cardViewPeople.setOnClickListener {
            val action = AidSelectFragmentDirections.actionAidSelectFragmentToAidMapFragment("requirement")
            Navigation.findNavController(it).navigate(action)
        }
